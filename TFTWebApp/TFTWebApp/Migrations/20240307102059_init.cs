        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OcekivaniHonorar = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PocetakSnimanja = table.Column<DateTime>(type: "datetime2", nullable: false),
                    KrajSnimanja = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Films_Persons_DirektorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmGlumac", x => new { x.FilmId, x.GlumacId });
                    table.ForeignKey(
                        name: "FK_FilmGlumac_Films_FilmId",
                        column: x => x.FilmId,
                        principalTable: "Films",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilmGlumac_Persons_GlumacId",
                        column: x => x.GlumacId,
                        principalTable: "Persons",
                        principalColumn: "Id");
                });
